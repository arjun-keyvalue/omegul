...
class UserTableMap extends TableMap
{
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Username', 'IpAddress', 'CreatedAt', 'UpdatedAt', ],
        self::TYPE_CAMELNAME     => ['id', 'username', 'ipAddress', 'createdAt', 'updatedAt', ],
        self::TYPE_COLNAME       => [UserTableMap::COL_ID, UserTableMap::COL_USERNAME, UserTableMap::COL_IP_ADDRESS, UserTableMap::COL_CREATED_AT, UserTableMap::COL_UPDATED_AT, ],
        self::TYPE_FIELDNAME     => ['id', 'username', 'ip_address', 'created_at', 'updated_at', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Username' => 1, 'IpAddress' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'username' => 1, 'ipAddress' => 2, 'createdAt' => 3, 'updatedAt' => 4, ],
        self::TYPE_COLNAME       => [UserTableMap::COL_ID => 0, UserTableMap::COL_USERNAME => 1, UserTableMap::COL_IP_ADDRESS => 2, UserTableMap::COL_CREATED_AT => 3, UserTableMap::COL_UPDATED_AT => 4, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'username' => 1, 'ip_address' => 2, 'created_at' => 3, 'updated_at' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'ipAddress' => 'IP_ADDRESS',
        'user.ipAddress' => 'IP_ADDRESS',
        'UserTableMap::COL_IP_ADDRESS' => 'IP_ADDRESS',
    ...
    {
        $this->addRelation('Message', '\\Message', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
        ...
        $this->addRelation('Secret', '\\Secret', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
  ),
), null, null, 'Secrets', false);
    }
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserTableMap::COL_IP_ADDRESS);
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(UserTableMap::COL_IP_ADDRESS);
