...
abstract class Message implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\MessageTableMap';
    ...
    public function setContent($v)
    {
        ...
        if ($this->content !== $v) {
            $this->content = $v;
            $this->modifiedColumns[MessageTableMap::COL_CONTENT] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MessageTableMap::translateFieldName('Content', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('message_id_seq')");
        ...
        if ($this->isColumnModified(MessageTableMap::COL_CONTENT)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(MessageTableMap::COL_CONTENT)) {
            $criteria->add(MessageTableMap::COL_CONTENT, $this->content);
        }
        if ($this->isColumnModified(MessageTableMap::COL_USER_ID)) {
