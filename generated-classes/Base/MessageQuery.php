 ...
 * @method     ChildMessageQuery orderByContent($order = Criteria::ASC) Order by the content column
 ...
 * @method     ChildMessageQuery groupByContent() Group by the content column
 ...
 * @method     ChildMessage|null findOneByContent(string $content) Return the first ChildMessage filtered by the content column
 * @method     ChildMessage|null findOneByUserId(int $user_id) Return the first ChildMessage filtered by the user_id column
 ...
 * @method     ChildMessage requireOneByContent(string $content) Return the first ChildMessage filtered by the content column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildMessage[]|Collection findByContent(string|array<string> $content) Return ChildMessage objects filtered by the content column
 * @psalm-method Collection&\Traversable<ChildMessage> findByContent(string|array<string> $content) Return ChildMessage objects filtered by the content column
 * @method     ChildMessage[]|Collection findByUserId(int|array<int> $user_id) Return ChildMessage objects filtered by the user_id column
 * @psalm-method Collection&\Traversable<ChildMessage> findByUserId(int|array<int> $user_id) Return ChildMessage objects filtered by the user_id column
...
abstract class MessageQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, content, user_id, created_at, updated_at FROM message WHERE id = :p0';
        try {
    ...
    public function filterByContent($content = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(MessageTableMap::COL_CONTENT, $content, $comparison);
    ...
    public function filterByUserId($userId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(MessageTableMap::COL_USER_ID, $userId, $comparison);
    ...
    public function filterByUpdatedAt($updatedAt = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(MessageTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
